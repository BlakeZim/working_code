...
def ReviseLandmarks(imlist,landmarks):
    '''A function for updating already chosen landmarks in the imlist. landmarks should be a list in the format of (Npoints X Ndimensions X Nimages). imlist is a list of images in numpy format. The order of the images in imlist should correspond to the order of the landmarks in the Nimages dimension.'''
